...
auto compareForPairs(
    const ROOT::RVec<float> &lep1pt, const ROOT::RVec<float> &lep1eta,
    const ROOT::RVec<float> &lep1phi, const ROOT::RVec<float> &lep1mass,
    const ROOT::RVec<float> &lep2pt, const ROOT::RVec<float> &lep2eta,
    const ROOT::RVec<float> &lep2phi, const ROOT::RVec<float> &lep2mass);
