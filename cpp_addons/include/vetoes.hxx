 ...
 * The columns `eta`, `phi`, `charge` contain the values of the lepton
 * observables for each lepton in the event. The parameter `min_delta_r` is the
 * minimum eta-phi separation of two leptons.
 *
 * @param eta The lepton pseudorapidity.
 * @param phi The lepton azimuthal angle.
 * @param charge The lepton charge.
 * @param min_delta_r The minimum spatial distance between leptons to be
 * considered for the veto.
 * @param logger_function_name name of the logger to be used.
 */
inline auto dilepton_veto(const ROOT::RVec<int> &object_index,
