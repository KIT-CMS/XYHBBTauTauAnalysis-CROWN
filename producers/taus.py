...
TauPtCut = Producer(
    name="TauPtCut",
    call="physicsobject::CutMin<float>({df}, {input}, {output}, {min_tau_pt})",
...
TauEtaCut = Producer(
    name="TauEtaCut",
    call="physicsobject::CutAbsMax<float>({df}, {input}, {output}, {max_tau_eta})",
...
TauDzCut = Producer(
    name="TauDzCut",
    call="physicsobject::CutAbsMax<float>({df}, {input}, {output}, {max_tau_dz})",
