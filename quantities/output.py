...
# fatjets
loose_electron_index = Quantity("loose_electron_index")
loose_muon_index = Quantity("loose_muon_index")
fatjet_index_no_veto = Quantity("fatjet_index_no_veto")
fatjet_electron_match_index = Quantity("fatjet_electron_match_index")
fatjet_muon_match_index = Quantity("fatjet_electron_match_index")
...
fatjet_mass_sd = Quantity("fatjet_mass_sd")
fatjet_mass_pnet = Quantity("fatjet_mass_pnet")
fatjet_pnet_qcd = Quantity("fatjet_pnet_qcd")
fatjet_pnet_xbb_vs_qcd = Quantity("fatjet_pnet_xbb_vs_qcd")
fatjet_pnet_xte_vs_qcd = Quantity("fatjet_pnet_xte_vs_qcd")
fatjet_pnet_xtm_vs_qcd = Quantity("fatjet_pnet_xtm_vs_qcd")
fatjet_pnet_xtt_vs_qcd = Quantity("fatjet_pnet_xtt_vs_qcd")
fatjet_n_electron_matches = Quantity("fatjet_n_electron_matches")
fatjet_n_muon_matches = Quantity("fatjet_n_muon_matches")
fatjet_matched_electron_pt_1 = Quantity("fatjet_matched_electron_pt_1")
fatjet_matched_electron_eta_1 = Quantity("fatjet_matched_electron_eta_1")
fatjet_matched_electron_phi_1 = Quantity("fatjet_matched_electron_phi_1")
fatjet_matched_electron_mass_1 = Quantity("fatjet_matched_electron_mass_1")
fatjet_matched_electron_charge_1 = Quantity("fatjet_matched_electron_charge_1")
fatjet_matched_electron_pt_2 = Quantity("fatjet_matched_electron_pt_2")
fatjet_matched_electron_eta_2 = Quantity("fatjet_matched_electron_eta_2")
fatjet_matched_electron_phi_2 = Quantity("fatjet_matched_electron_phi_2")
fatjet_matched_electron_mass_2 = Quantity("fatjet_matched_electron_mass_2")
fatjet_matched_electron_charge_2 = Quantity("fatjet_matched_electron_charge_2")
fatjet_matched_muon_pt_1 = Quantity("fatjet_matched_muon_pt_1")
fatjet_matched_muon_eta_1 = Quantity("fatjet_matched_muon_eta_1")
fatjet_matched_muon_phi_1 = Quantity("fatjet_matched_muon_phi_1")
fatjet_matched_muon_mass_1 = Quantity("fatjet_matched_muon_mass_1")
fatjet_matched_muon_charge_1 = Quantity("fatjet_matched_muon_charge_1")
fatjet_matched_muon_pt_2 = Quantity("fatjet_matched_muon_pt_2")
fatjet_matched_muon_eta_2 = Quantity("fatjet_matched_muon_eta_2")
fatjet_matched_muon_phi_2 = Quantity("fatjet_matched_muon_phi_2")
fatjet_matched_muon_mass_2 = Quantity("fatjet_matched_muon_mass_2")
fatjet_matched_muon_charge_2 = Quantity("fatjet_matched_muon_charge_2")
